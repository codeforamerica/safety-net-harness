...
export const sspLivingArrangementCategoryEnum = z.enum([
  'independent_living',
  'living_in_household_of_another',
  'board_and_care',
  'skilled_nursing',
  'other',
]);
...
export const personSchema = z.object({
  ...
  shareOfCostAmount: z.number().optional(),
  sspAmount: z.number().optional(),
  sspLivingArrangementCategory: sspLivingArrangementCategoryEnum.optional(),
  calsawsClientId: z.string().optional(),
  mediCalAidCode: z.string().optional(),
});
...
export const householdSchema = z.object({
  ...
  californiaResidencyVerified: z.boolean().optional(),
});
